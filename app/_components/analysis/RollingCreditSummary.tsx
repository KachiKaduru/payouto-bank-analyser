  ...
  return (
    <section className="rounded-3xl bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 p-6 shadow-sm">
      ...
      <p className="text-gray-700 text-sm leading-relaxed">
        ...
        <strong> {formatNaira(rc.total30)}</strong>. Over the last <strong>90 days</strong>, that
        rises to <strong>{formatNaira(rc.total90)}</strong>—an average of{" "}
        ...
        <strong>{formatNaira(rc.avg180)}</strong> per month.
        <br />
        <br />
