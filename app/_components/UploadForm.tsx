        ...
        <div>
          ...
          <div className="relative w-full">
            <input
              ...
              className="border border-gray-300 p-3 rounded-xl w-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
            ...
            <AnimatePresence>
              {search && (
                <motion.ul
                  ...
                  exit={{ opacity: 0, y: -5 }}
                  className="absolute left-0 right-0 bg-white border border-gray-200 mt-1 max-h-48 overflow-y-auto rounded-xl shadow-lg z-20"
                >
