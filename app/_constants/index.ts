...
export const banksList = [
  ...
  { id: 8, value: "nomba", label: "Nomba Bank" },
  { id: 9, value: "opay", label: "Opay MFB" },
  { id: 10, value: "stanbic", label: "Stanbic IBTC Bank" },
  { id: 11, value: "sterling", label: "Sterling Bank" },
  { id: 12, value: "uba", label: "UBA" },
  { id: 13, value: "union", label: "Union Bank" },
  { id: 14, value: "wema", label: "WEMA Bank" },
  { id: 15, value: "zenith", label: "Zenith Bank" },
];
